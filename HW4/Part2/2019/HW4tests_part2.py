...
class HW4_part2_SampleTests(unittest.TestCase):
    ...
    def test_input3(self):
        ...
        print("opstack type: ", type(opstackOutput))
    ...
    def test_input12(self):
        testinput12 = """
            /stuff { 0 exch {mul} forall } def
            /x 7 def
            /y 1 def
            [5 2 3 sub 0 x] stuff
            [y x sub 5 2] stuff
            [x y 5 div 2 mul 12] stuff
        """
        opstackOutput = [0, 0, 0]
    ...
    def test_input13(self):
        testinput13 = """
            7 8 9 10 11 count copy 15 5 {exch add} repeat 0 eq  
        """
        opstackOutput = [7,8,9,10,11,False]
    ...
    def test_input15(self):
        testinput15 = """
            ...
            0 eq true and
        """
        opstackOutput = [0, -2, -2, 'div', -2, -2, 'div', 2, 2, 'div', -2, -2, 'div', 2, 2, True]
    ...
    def test_input3(self):
        testinput3 = """
             [3 2 1 3 2 2 3 5 5] dup  
             3
             [4 2 1 4 2 3 4 5 1] 7 3 getinterval
             putinterval
         """
        opstackOutput = [[3,2,1,5,1,2,3,5,5]]
        print("opstack type: ", type(opstackOutput))
        interpreter(testinput3)
        self.assertEqual(opstack,opstackOutput)
